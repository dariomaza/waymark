...
export class MissingWebClient extends Error {
  constructor(root: string) {
    super(
      `WAYMARK_WEB_ROOT is ${root}, which holds no ${SHELL}. Build the client with \`pnpm --filter @waymark/web build\`, or leave the variable unset to run the API on its own.`,
    );
